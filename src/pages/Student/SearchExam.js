...
import styles from './SearchExam.less';
...
@Form.create()
class SearchExam extends PureComponent {
  handleSubmit = e => {
      ...
      >
        <Card bordered={false}>
          <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
            <FormItem {...formItemLayout} label={<FormattedMessage id="form.student.searchExam" />}>
